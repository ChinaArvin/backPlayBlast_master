...
class MainWindow(QMainWindow):
    ...
    def createActions(self):
        self.fileOpenAction = QAction(QIcon("E:\pycharm\QMainWindow\images\Animal.ico"), self.tr("打开"), self)
        ...
        self.fileNewAction = QAction(QIcon("E:\pycharm\QMainWindow\images\Animal.ico"), self.tr("新建"), self)
    ...
    def slotAbout(self):
        QMessageBox.about(self,"about me", self.tr("这是我们的第一个例子"))
